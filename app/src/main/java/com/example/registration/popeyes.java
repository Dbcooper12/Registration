...
public class popeyes extends AppCompatActivity {
    ...
    ListView lista;
    String[][] datos = {
            {"Popeyes Chicken Sandwich","popeyes","S/.44.00","9","2020/11/","Paul Zapata"},
            {"Cajun Maria","popeyes","S/.19.90","7","2020/11/","Danny Peralta Perez" },
            {"+ Festi + Golazo","popeyes","S/.39.90","7","2020/11/","Arnold Roque" },
            {"CHICKEN MIX","popeyes","S/.9.90","7","2020/11/","Monica Samillan" },
            {"Lunes de Alitas","popeyes","S/.12.90","7","2020/11/","Bochini Bochini" }
    };
