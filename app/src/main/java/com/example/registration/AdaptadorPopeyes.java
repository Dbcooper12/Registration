...
public class AdaptadorPopeyes extends BaseAdapter {
    ...
    public AdaptadorPopeyes(Context context, String[][] datos, int[] datosImg) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        final View vista = inflater.inflate(R.layout.popeye,null);
        ...
        imagen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent visorImagen = new Intent(context,visor_imagen_popeyes.class);
        ...
        titulo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent visorDetalles = new Intent(context,detalle_popeyes.class);
